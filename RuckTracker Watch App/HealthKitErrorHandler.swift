...
enum HealthKitError: LocalizedError, Equatable {
    ...
    var recoverySuggestion: String? {
        ...
        case .authorizationDenied(let dataType):
            return "To enable \(dataType) tracking, open Health app on iPhone > Sharing > Apps > RuckTracker."
        case .authorizationNotDetermined:
        ...
        case .workoutSessionCreationFailed, .workoutBuilderCreationFailed:
            return "Try ending any active workouts in the Workout app and restart RuckTracker."
        ...
        case .permissionRevoked:
            return "Open Health app on iPhone > Sharing > Apps > RuckTracker to restore permissions."
        case .healthStoreUnavailable:
            return "Restart the Health app and try again."
        case .networkError:
            return "Check your internet connection and try again."
        case .insufficientPermissions:
            return "Grant additional HealthKit permissions in the Health app on your iPhone."
        case .deviceNotSupported:
            return "Some features may not be available on this Apple Watch model."
        case .backgroundProcessingRestricted:
            return "Check Battery settings for background app restrictions."
        }
    }
